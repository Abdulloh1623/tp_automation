...
export default function Loading() {
  return (
    <div className="animate-pulse space-y-5">
      ...
      <div className="h-16 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900" />

      {/* Jadval/ro'yxat skeleton */}
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        <div className="h-10 border-b border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-800/60" />
